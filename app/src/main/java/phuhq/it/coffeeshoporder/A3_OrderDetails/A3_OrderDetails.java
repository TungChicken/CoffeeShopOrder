...
public class A3_OrderDetails extends AppCompatActivity {
    ...
    private A3_OrderDetailsAdapter detailsAdapter;
    ...
    public void LoadDrinkList() {
        try {
            ...
            List<A3_Drink> drinkList = new ArrayList<>();
            ...
            // Khởi tạo apdater
            detailsAdapter = new A3_OrderDetailsAdapter(this, R.layout.a3_order_details_item, drinkList);
